    ...
    <div id="top" className="min-h-screen bg-gray-50 text-gray-900">
      ...
      <main className="max-w-5xl mx-auto px-4 sm:px-6 py-10">
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-5 mb-10">
          ...
          <ol className="list-decimal ml-5 space-y-1 text-sm sm:text-base">
            ...
            <li>
              <a
                className="text-[#2AB09C] hover:underline"
                href="#services-and-platform"
              >
                Definition of Services & Nature of Platform
              </a>
            </li>
            <li>
              <a
                className="text-[#2AB09C] hover:underline"
                href="#eligibility-and-account"
              >
            ...
            <li>
              <a
                className="text-[#2AB09C] hover:underline"
                href="#free-service-and-financial"
              >
                Free Service Model and Financial Disclaimers
              </a>
            </li>
            <li>
              <a
            ...
            <li>
              <a className="text-[#2AB09C] hover:underline" href="#ip-rights">
            ...
            <li>
              <a className="text-[#2AB09C] hover:underline" href="#disclaimer">
            ...
            <li>
              <a className="text-[#2AB09C] hover:underline" href="#termination">
                Termination
              </a>
            </li>
            <li>
        ...
        <section id="acceptance-of-terms" className="space-y-4 mb-10">
          ...
          <p>
            Welcome to EasyLease ("Platform," "Site," "we," "us," "our"),
            accessible at www.easylease.services and its associated mobile
            applications. These Terms and Conditions of Use ("Terms") constitute
            a legally binding agreement between you ("User," "you," "your") and
            EasyLease governing your access to and use of this Platform and all
            content, functionality, and services offered on or through
            EasyLease.
          </p>
          <p>
            By accessing, browsing, or using the EasyLease platform in any
            manner, you acknowledge that you have read, understood, and
            unconditionally agree to be bound by these terms. If you do not
            agree to all of these terms and conditions, you are expressly
          ...
          <p>
            ...
            continued use of the Platform after the date such revised Terms are
            posted.
          </p>
        </section>
        ...
        <section id="services-and-platform" className="space-y-4 mb-10">
          <h2 className="text-xl font-semibold">
            2. Definition of Services & Nature of Platform
          </h2>
          <h3 className="font-medium"> 2.1. Service Description: </h3>
          <p>
            EasyLease provides a digital marketplace that facilitates
            connections between individuals and/or entities seeking to list,
            rent, lease, or find residential and commercial properties
            ("Listers") and individuals and/or entities seeking to identify,
            view, and potentially rent or lease such properties ("Seekers"). The
            services ("Services") include, but are not limited to:
          </p>
          <ul className="list-disc ml-6 space-y-1">
            <li>
              Hosting user-generated property listings, including descriptions,
              photographs, and contact information.
            </li>
            <li>
              {" "}
              Providing search tools and filters for Seekers to browse listings.
            </li>
            <li>
              {" "}
              Enabling communication between Listers and Seekers through the
              Platform.
            </li>
            <li>
              Offering ancillary services designed to assist in the rental
              process (e.g., facilitation of tenant verification, legal
              documentation, etc.).
            </li>
          </ul>
          <h3 className="font-medium"> 2.2. Platform Role – Disclaimer: </h3>
          <p>
            EasyLease acts solely as an intermediary and a hosting platform. We
            are not a real estate broker, agent, or insurer. We are not a party
            to any rental, lease, or other agreement between Users. We do not
            own, sell, or manage the properties listed on the site. We do not
            endorse any User, property, or listing. We are not involved in the
            actual transaction between Listers and Seekers.
          </p>
        </section>
        ...
        <section id="eligibility-and-account" className="space-y-4 mb-10">
          ...
          <p>
            To use the EasyLease Platform, you must be at least eighteen (18)
            years of age and possess the legal authority, right, and capacity to
            enter into these Terms and to use the Platform in accordance with
            all terms and conditions herein.
          </p>
          <h3 className="font-medium"> 3.2. Account Registration: </h3>
          <p>
            {" "}
            To access certain features of the Platform, you must register to
            create an account ("Account"). You agree to:
          </p>
          <ul className="list-disc ml-6 space-y-1">
            <li>
              Provide accurate, current, and complete information during the
              registration process ("Registration Data").
            </li>
            <li>
            ...
            <li>
              Accept sole responsibility for all activities that occur under
          ...
          <p>
            You may not create an Account for anyone other than yourself without
            their express permission. You may not use a username that is the
            name of another person with the intent to impersonate that person,
            or that is subject to any rights of another person without
        ...
        <section id="free-service-and-financial" className="space-y-4 mb-10">
          <h2 className="text-xl font-semibold">
            4. Free Service Model and Financial Disclaimers
          </h2>
          <h3 className="font-medium">4.1. No Fees: </h3>
          <p>
            The core services of the EasyLease Platform—including account
            registration, property listing, browsing, and basic
            communication—are provided to all users free of charge. EasyLease
            does not currently charge any listing fees, subscription fees,
            success fees, or commissions.
          </p>
          <h3 className="font-medium">
            {" "}
            4.2. No Involvement in Transactions:{" "}
          </h3>
          <p>
            EasyLease is not a party to any rental or lease agreement negotiated
            between Users. All financial arrangements, including security
            deposits, rent payments, brokerage fees (if any, agreed upon outside
            the Platform), and other monetary transactions, are conducted solely
            between the Lister and the Seeker, outside of the EasyLease
            Platform.
          </p>
          <h3 className="font-medium">
            {" "}
            4.3. Absolute Disclaimer of Financial Liability:{" "}
          </h3>
          <p>
            You acknowledge and agree that EasyLease is not responsible for, and
            shall have no liability in relation to, any financial transactions
            between Users. This includes, but is not limited to:
          </p>
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>
              Any fees or commissions agreed upon between a User and a
              third-party broker or agent.{" "}
            </li>
          </ul>
          <p>
            Users are solely responsible for verifying the identity and
            credentials of other Users and for ensuring that all payment
            transactions are secure and conducted through reliable and traceable
            methods.
          </p>
        </section>
        ...
        <section id="user-conduct" className="space-y-4 mb-10">
          ...
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>
              To impersonate or attempt to impersonate EasyLease, an EasyLease
              employee, another user, or any other person or entity.
            </li>
            <li>
              To engage in any other conduct that restricts or inhibits anyone's
              use or enjoyment of the Platform, or which, as determined by us,
              may harm EasyLease or users of the Platform or expose them to
              liability.
            </li>
          </ul>
          ...
          <p>
            {" "}
            You are solely responsible for all content, including text, images,
            photos, audio, video, and other materials ("Content"), that you
            upload, post, publish, or display on the Platform. You represent and
            warrant that you own or have the necessary rights to all Content you
            submit and that such Content does not:
          </p>
          <ul className="list-disc ml-6 space-y-1">
            <li>
            ...
            <li>
              Violate, or encourage any conduct that would violate, any
            ...
            <li>
              Contain any material that is defamatory, obscene, pornographic,
              indecent, abusive, offensive, harassing, violent, hateful,
              inflammatory, or otherwise objectionable.
            </li>
            <li>
              Involve commercial activities or sales without our express written
              consent, such as contests, sweepstakes, or other sales promotions.
            </li>
          </ul>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>
              You hold all necessary rights, title, and interest to the property
              listed, including the authority to offer it for rent or lease.
            </li>
            <li>
              All information provided in the listing is accurate, complete, and
              not misleading, including but not limited to the property's size,
              amenities, condition, availability, and rental price.
            </li>
            <li>
              You will deal with inquiries from Seekers in a timely,
          ...
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>
              Exercise your own independent judgment and perform your own due
              diligence before entering into any agreement. This includes
              physically inspecting the property, verifying ownership/rights of
              the Lister, reviewing all legal documents (e.g., lease
              agreements), and ensuring the terms are acceptable to you.
            </li>
          </ul>
        </section>
        ...
        <section id="ip-rights" className="space-y-4 mb-10">
          ...
          <p>
            ...
            arrangement thereof) are owned by EasyLease, its licensors, or other
          ...
          <p>
            Subject to your compliance with these Terms, EasyLease grants you a
            limited, non-exclusive, non-transferable, non-sublicensable, and
            revocable license to access and use the Platform for your personal,
            non-commercial use.
          </p>
          <h3 className="font-medium">
            {" "}
          ...
          <p>
            ...
            you grant EasyLease a worldwide, perpetual, irrevocable,
            non-exclusive, royalty-free, fully-paid, transferable, and
            sub-licensable license to use, copy, modify, create derivative works
            based upon, distribute, publicly display, publicly perform, and
            otherwise exploit such Content in any form, medium, or technology
            now known or later developed, for the purposes of operating,
            promoting, and improving the Platform.
          </p>
          <p>
            You waive any and all moral rights to such Content. You represent
            and warrant that you have all rights necessary to grant us this
            license.
          </p>
        </section>
        ...
        <section id="privacy-policy" className="space-y-4 mb-10">
          ...
          <p>
            ...
            incorporated into these Terms by reference, describes how we
        ...
        <section id="disclaimer" className="space-y-4 mb-10">
          ...
          <p>
            Your use of the platform and its content is at your own risk. The
            platform and all content are provided on an "as is" and "as
            available" basis, without any warranties of any kind, either express
            or implied. Neither EasyLease nor any person associated with
            EasyLease makes any warranty or representation with respect to the
            completeness, security, reliability, quality, accuracy, or
            availability of the platform.
          </p>
          <p>
            Without limiting the foregoing, neither EasyLease nor anyone
            associated with the company represents or warrants that the platform
            will be accurate, reliable, error-free, or uninterrupted, that
            defects will be corrected, that the platform or the server that
            makes it available are free of viruses or other harmful components,
            or that the platform will otherwise meet your needs or expectations.
          </p>
          <p>
            EasyLease hereby disclaims all warranties of any kind, whether
        ...
        <section id="limitation-of-liability" className="space-y-4 mb-10">
          ...
          <p>
            To the fullest extent provided by law, in no event shall EasyLease,
        ...
        <section id="indemnification" className="space-y-4 mb-10">
          ...
          <p>
            You agree to defend, indemnify, and hold harmless EasyLease, its
            ...
            Platform, including, but not limited to: (i) your User
            Contributions; (ii) your interaction with any other User; (iii) your
            ...
            Content caused damage to a third party. This indemnification
        ...
        <section id="termination" className="space-y-4 mb-10">
          ...
          <p>
            You may deactivate your Account at any time by contacting us or
            using the tools provided within your Account settings.
          </p>
          ...
          <ul className="list-disc ml-6 space-y-1">
            <li>
              ...
              for any reason, including without limitation, if we believe you
              have violated these Terms.
            </li>
            <li>
              Change, suspend, or discontinue all or any part of the Platform at
              any time.
            </li>
        ...
        <section id="governing-law" className="space-y-4 mb-10">
          ...
          <p>
            These Terms and your use of the Platform shall be governed by and
            ...
            located in New Delhi, India, and you hereby irrevocably consent to
        ...
        <section id="grievance-officer" className="space-y-4 mb-10">
          ...
          <div className="rounded-lg border border-gray-200 p-4 bg-white">
            ...
            <p>
              <span className="font-medium">Phone:</span> 8448163874
            </p>
          </div>
          <p className="text-sm text-gray-600">
            You may contact the Grievance Officer to report any violations of
            these Terms or to resolve any complaints regarding the Platform or
            any Content.
          </p>
        </section>
        ...
        <section id="miscellaneous" className="space-y-4 mb-10">
          ...
          <p>
            <span className="font-medium"> 14.1. Entire Agreement:</span> These
            Terms, together with our Privacy Policy, constitute the sole and
            entire agreement between you and EasyLease regarding the Platform
          ...
          <p>
            <span className="font-medium"> 14.2. Severability:</span> If any
          ...
          <p>
            <span className="font-medium">14.3. No Waiver:</span> No waiver by
            EasyLease of any term or condition outlined in these Terms shall be
            deemed a further or continuing waiver of such term or condition or a
            waiver of any other term or condition, and any failure of EasyLease
            to assert a right or provision under these Terms shall not
            constitute a waiver of such right or provision.
          </p>
          <p>
            <span className="font-medium">14.4. Contact Information:</span> For
            any questions about these Terms, please contact us at [Insert your
            general contact email address].
          </p>
          <p className="italic text-gray-600">
            Your Easy Way to Find a Place to Call Home.
          </p>
        </section>

        <div className="mt-12">
          <a href="#top" className="text-sm text-[#2AB09C] hover:underline">
            Back to top
          </a>
        </div>
      </main>
