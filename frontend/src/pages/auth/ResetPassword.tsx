    ...
    <main className="min-h-screen bg-gray-50 py-10">
      <div className="mx-auto w-full max-w-md px-4">
        <div className="rounded-2xl border bg-white p-6 shadow-sm">
          ...
          {err && (
            <div className="mt-3 bg-red-50 border-l-4 border-red-500 p-3 text-red-700 rounded">
              {err}
            </div>
          )}
          {info && (
            <div className="mt-3 bg-emerald-50 border-l-4 border-emerald-500 p-3 text-emerald-700 rounded">
              {info}
            </div>
          )}
